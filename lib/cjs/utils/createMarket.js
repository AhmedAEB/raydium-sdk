...
class MarketV2 extends base_1.Base {
    ...
    static makeCreateMarketInstruction({ connection, wallet, marketInfo, }, n = 1) {
        return __awaiter(this, void 0, void 0, function* () {
            const ins1 = [];
            ...
            ins2.push(web3_js_1.SystemProgram.createAccountWithSeed({
                ...
                lamports: yield connection.getMinimumBalanceForRentExemption(Math.ceil(5120 / n) + 12),
                ...
                lamports: yield connection.getMinimumBalanceForRentExemption(Math.ceil(262144 / n) + 12),
                ...
                lamports: yield connection.getMinimumBalanceForRentExemption(Math.ceil(65536 / n) + 12),
