    ...
    static makeCreateMarketInstruction({ connection, wallet, marketInfo, }, n = 1) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            ins2.push(web3_js_1.SystemProgram.createAccountWithSeed({
                ...
                lamports: yield connection.getMinimumBalanceForRentExemption(5120 / n + 12),
                space: 5120 / n + 12,
                programId: marketInfo.programId,
            }), web3_js_1.SystemProgram.createAccountWithSeed({
                fromPubkey: wallet,
                ...
                lamports: yield connection.getMinimumBalanceForRentExemption(262144 / n + 12),
                space: 262144 / n + 12,
                programId: marketInfo.programId,
            }), web3_js_1.SystemProgram.createAccountWithSeed({
                fromPubkey: wallet,
                ...
                lamports: yield connection.getMinimumBalanceForRentExemption(65536 / n + 12),
                space: 65536 / n + 12,
                programId: marketInfo.programId,
            }), web3_js_1.SystemProgram.createAccountWithSeed({
                fromPubkey: wallet,
